...
export const countries: Country[] = [
    ...
    { value: 'Congo (Congo-Brazzaville)', label: 'Congo (Congo-Brazzaville)', code: 'CG' },
    ...
    { value: 'Czechia (Czech Republic)', label: 'Czechia (Czech Republic)', code: 'CZ' },
    { value: 'Democratic Republic of the Congo', label: 'Democratic Republic of the Congo', code: 'CD' },
    ...
    { value: 'Eswatini (fmr. "Swaziland")', label: 'Eswatini (fmr. "Swaziland")', code: 'SZ' },
    ...
    { value: 'Myanmar (formerly Burma)', label: 'Myanmar (formerly Burma)', code: 'MM' },
    ...
    { value: 'Palestine State', label: 'Palestine State', code: 'PS' },
    ...
    { value:d: 'South Sudan', label: 'South Sudan', code: 'SS' },
